...
public class DeusEx : SimpleTCPPack<SimpleTCPServerConnector>
{
    ...
    public override EffectList Effects { get; } = new Effect[]
    {
        ...
        new("Lose your Marbles", "drop_marbles"){Price = 3,Description = "Oops, JC dropped all the marbles!"}, //New for sixth Crowd Control batch
        new("Drop some Pamphlets", "spam_datacubes"){Price = 3,Description = "Air drop a selection of informative datacubes around the level!"}, //New for sixth Crowd Control batch
        ...
        new("Blood for the Blood God", "blood_god"){Price = 1,Description = "Bestow an offering to the Blood God and make everything bleed!"}, //New for sixth Crowd Control batch
